...
Please note that some content will not work with Ansible 2.9 releases before 2.9.20, and ansible-base 2.10 releases before 2.10.8. If you are using such a version, please upgrade to a newer (or better: latest) version of Ansible 2.9 or ansible-base 2.10 respectively, or preferably to an ansible-core version.
