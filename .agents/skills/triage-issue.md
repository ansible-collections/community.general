...
## 1. Check the content of issue

Follow `.agents/rules/github-issue.md`. Classify correctly (bugfix vs feature).
Determine whether the issue title or description is compliant with the rules or needs adjustments.
