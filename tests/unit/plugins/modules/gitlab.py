...
def resp_get_user(url, request):
    headers = {"content-type": "application/json"}
    content = (
        '{"id": 1, "username": "john_smith", "name": "John Smith",'
        '"state": "active",'
        '"avatar_url": "http://localhost:3000/uploads/user/avatar/1/cd8.jpeg",'
...
def resp_find_group(url, request):
    headers = {"content-type": "application/json"}
    content = (
        '[{"id": 1, "name": "Foobar Group", "path": "foo-bar",'
...
def resp_create_subgroup(url, request):
    headers = {"content-type": "application/json"}
    content = (
        '{"id": 2, "name": "BarFoo Group", "path": "bar-foor",'
        '"description": "An interesting group", "visibility": "public",'
        '"lfs_enabled": true, "avatar_url": "http://localhost:3000/uploads/group/avatar/2/bar.jpg",'
...
def resp_create_group_access_tokens(url, request):
    headers = {"content-type": "application/json"}
    content = (
        '{"user_id" : 1, "scopes" : ["api"], "name" : "token1", "expires_at" : "2021-01-31",'
...
def resp_get_member(url, request):
    headers = {"content-type": "application/json"}
    content = (
        '{"id": 1, "username": "raymond_smith", "name": "Raymond Smith", "state": "active",'
...
def resp_get_protected_branch(url, request):
    headers = {"content-type": "application/json"}
    content = (
        '{"id": 1, "name": "master", "push_access_levels": [{"access_level": 40, "access_level_description": "Maintainers"}],'
...
def resp_find_runners_all(url, request):
    ...
    content = (
        '[{"active": true,"description": "test-1-20150125","id": 1,'
...
def resp_find_runners_list(url, request):
    ...
    content = (
        '[{"active": true,"description": "test-1-20201214","id": 1,'
        '"is_shared": false,"ip_address": "127.0.0.1","name": null,'
        '"online": true,"status": "online"},{"active": true,'
...
def resp_find_project_runners(url, request):
    ...
    content = (
        '[{"active": true,"description": "test-1-20220210","id": 1,'
        '"is_shared": false,"ip_address": "127.0.0.1","name": null,'
        '"online": true,"status": "online"},{"active": true,'
...
def resp_find_group_runners(url, request):
    ...
    content = (
        '[{"active": true,"description": "test-3-20220210","id": 1,'
        '"is_shared": false,"ip_address": "127.0.0.1","name": null,'
        '"online": true,"status": "online"},{"active": true,'
