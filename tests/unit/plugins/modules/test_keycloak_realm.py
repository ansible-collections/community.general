...
class TestKeycloakRealm(ModuleTestCase):
    ...
    def test_create_when_absent(self):
        ...
        return_value_created = [{"code": 201, "id": "realm-name", "realm": "realm-name", "enabled": True}]
        changed = True
    ...
    def test_create_when_present_with_change(self):
        ...
        return_value_absent = [
            {"id": "realm-name", "realm": "realm-name", "enabled": True},
            {"id": "realm-name", "realm": "realm-name", "enabled": False},
        ]
        return_value_updated = [{"code": 201, "id": "realm-name", "realm": "realm-name", "enabled": False}]
        changed = True
    ...
    def test_create_when_present_no_change(self):
        ...
        return_value_updated = [{"code": 201, "id": "realm-name", "realm": "realm-name", "enabled": True}]
        changed = False
    ...
    def test_delete_when_present(self):
        ...
        return_value_absent = [{"id": "realm-name", "realm": "realm-name"}]
        return_value_deleted = [None]
        changed = True
