...
try:
    ...
    try:
        from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_pool import Parameters
        from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_pool import ModuleManager
        from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_pool import PoolFactManager
        from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_pool import TypedPoolFactManager
