...
from ansible_collections.community.general.plugins.modules import checkpoint_session
...
class TestCheckpointAccessRule(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.checkpoint_session.Connection')
        return connection_class_mock.return_value

    @pytest.fixture
    def get_session_200(self, mocker):
        mock_function = mocker.patch('ansible_collections.community.general.plugins.modules.checkpoint_session.get_session')
