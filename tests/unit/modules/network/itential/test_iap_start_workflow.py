...
import mock
import unittest
from ansible_collections.community.general.plugins.modules.network.itential import iap_start_workflow


class TestWorkflowModule(unittest.TestCase):

    @mock.patch('ansible_collections.community.general.plugins.modules.network.itential.iap_start_workflow.start_workflow')
