...
class TestNetscalerCSPolicyModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.community.general.plugins.modules.netscaler_cs_policy.get_nitro_client', m):
            with patch('ansible_collections.community.general.plugins.modules.netscaler_cs_policy.nitro_exception', MockException):
                self.module = netscaler_cs_policy
                result = self.failed()
