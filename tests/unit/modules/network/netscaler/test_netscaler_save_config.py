...
class TestNetscalerSaveConfigModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        from ansible_collections.community.general.plugins.modules import netscaler_save_config
        ...
        with patch('ansible_collections.community.general.plugins.modules.netscaler_save_config.get_nitro_client', m):
            with patch('ansible_collections.community.general.plugins.modules.netscaler_save_config.nitro_exception', MockException):
    ...
    def test_graceful_no_connection_error(self):
        ...
        m = Mock(return_value=client_mock)
        with patch.multiple(
            'ansible_collections.community.general.plugins.modules.netscaler_save_config',
            get_nitro_client=m,
