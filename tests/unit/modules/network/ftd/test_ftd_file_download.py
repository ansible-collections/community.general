...
from ansible_collections.community.general.plugins.modules import ftd_file_download
...
class TestFtdFileDownload(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.ftd_file_download.Connection')
