...
from ansible_collections.community.general.plugins.modules import ftd_file_upload
...
class TestFtdFileUpload(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.ftd_file_upload.Connection')
