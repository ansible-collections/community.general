...
from ansible_collections.community.general.plugins.modules import ftd_configuration
...
class TestFtdConfiguration(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.ftd_configuration.Connection')
        return connection_class_mock.return_value

    @pytest.fixture
    def resource_mock(self, mocker):
        resource_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.ftd_configuration.BaseConfigurationResource')
