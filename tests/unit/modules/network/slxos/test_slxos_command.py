...
from ansible_collections.community.general.plugins.modules import slxos_command
...
class TestSlxosCommandModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.slxos_command.run_commands')
