...
from ansible_collections.community.general.plugins.modules import cnos_command
...
class TestCnosCommandModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.cnos_command.run_commands')
