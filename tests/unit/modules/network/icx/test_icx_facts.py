...
from ansible_collections.community.general.plugins.modules import icx_facts
...
class TestICXFactsModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.icx_facts.run_commands')
