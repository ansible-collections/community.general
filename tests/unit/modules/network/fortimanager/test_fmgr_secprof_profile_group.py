...
try:
    from ansible_collections.community.general.plugins.modules import fmgr_secprof_profile_group
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.fmgr_secprof_profile_group.Connection')
    return connection_class_mock
