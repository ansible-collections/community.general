...
try:
    from ansible_collections.community.general.plugins.modules import fmgr_fwpol_ipv4
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.fmgr_fwpol_ipv4.Connection')
    return connection_class_mock
