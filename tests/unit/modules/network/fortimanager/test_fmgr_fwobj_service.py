...
try:
    from ansible_collections.community.general.plugins.modules import fmgr_fwobj_service
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.fmgr_fwobj_service.Connection')
    return connection_class_mock
