...
try:
    from ansible_collections.community.general.plugins.modules import fmgr_secprof_proxy
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.community.general.plugins.modules.fmgr_secprof_proxy.Connection')
    return connection_class_mock
