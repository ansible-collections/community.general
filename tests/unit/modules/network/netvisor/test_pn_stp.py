...
from ansible_collections.community.general.plugins.modules import pn_stp
...
class TestStpModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.general.plugins.modules.pn_stp.run_cli')
