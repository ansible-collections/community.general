...
from ansible_collections.community.general.plugins.modules import pn_prefix_list_network
...
class TestPrefixListNetworkModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.general.plugins.modules.pn_prefix_list_network.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.community.general.plugins.modules.pn_prefix_list_network.check_cli')
