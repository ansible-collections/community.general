...
from ansible_collections.community.general.plugins.modules import enos_command
...
class TestEnosCommandModule(TestEnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.enos_command.run_commands')
