...
from ansible_collections.community.general.plugins.modules import edgeswitch_facts
...
class TestEdgeswitchFactsModule(TestEdgeswitchModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.edgeswitch_facts.run_commands')
