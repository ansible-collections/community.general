...
from ansible_collections.community.general.plugins.modules import edgeos_command
...
class TestEdgeosCommandModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.edgeos_command.run_commands')
