...
from ansible_collections.community.general.plugins.modules import dellos10_command
...
class TestDellos10CommandModule(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.dellos10_command.run_commands')
