...
from ansible_collections.community.general.plugins.modules import onyx_command
...
class TestOnyxCommandModule(TestOnyxModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.community.general.plugins.modules.onyx_command.run_commands')
