...
from ansible_collections.community.general.plugins.modules import routeros_facts
...
class TestRouterosFactsModule(TestRouterosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.routeros_facts.run_commands')
