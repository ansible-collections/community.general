...
from ansible_collections.community.general.plugins.modules.netapp_e_alerts import Alerts
...
class AlertsTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.community.general.plugins.modules.netapp_e_alerts.request'
