...
from ansible_collections.community.general.plugins.modules.netapp_e_syslog import Syslog
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.community.general.plugins.modules.netapp_e_syslog.request'
