...
from ansible_collections.netapp.aws.plugins.module_utils.netapp import NetAppESeriesModule
from ansible_collections.community.general.plugins.modules.netapp_e_volume import NetAppESeriesVolume
...
class NetAppESeriesVolumeTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'ansible_collections.community.general.plugins.modules.netapp_e_volume.NetAppESeriesVolume.request'
    GET_VOLUME_FUNC = 'ansible_collections.community.general.plugins.modules.netapp_e_volume.NetAppESeriesVolume.get_volume'
    SLEEP_FUNC = 'ansible_collections.community.general.plugins.modules.netapp_e_volume.sleep'
