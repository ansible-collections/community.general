...
from ansible_collections.community.general.plugins.modules.netapp_e_ldap import Ldap
...
class LdapTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.community.general.plugins.modules.netapp_e_ldap.request'
