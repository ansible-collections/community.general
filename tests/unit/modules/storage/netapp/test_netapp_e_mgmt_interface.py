...
from ansible_collections.community.general.plugins.modules.netapp_e_mgmt_interface import MgmtInterface
...
class MgmtInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.community.general.plugins.modules.netapp_e_mgmt_interface.request'
