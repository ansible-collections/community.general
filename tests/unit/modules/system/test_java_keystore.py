...
from ansible_collections.community.general.plugins.modules.java_keystore import create_jks, cert_changed, ArgumentSpec
...
class TestCreateJavaKeystore(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.general.plugins.modules.java_keystore.run_commands')
