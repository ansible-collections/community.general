...
def mocker_set(mocker, connection_exists=False):
    ...
    """
    mocker.patch('ansible_collections.community.general.plugins.modules.nmcli.HAVE_DBUS', True)
    mocker.patch('ansible_collections.community.general.plugins.modules.nmcli.HAVE_NM_CLIENT', True)
