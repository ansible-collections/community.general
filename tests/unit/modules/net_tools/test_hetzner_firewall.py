...
from ansible_collections.community.general.plugins.modules import hetzner_firewall
...
def run_module(mocker, module, arguments, fetch_url):
    ...
    mocker.patch('ansible_collections.community.general.plugins.modules.hetzner_firewall.AnsibleModule.exit_json', exit_json)
    mocker.patch('ansible_collections.community.general.plugins.modules.hetzner_firewall.AnsibleModule.fail_json', fail_json)
