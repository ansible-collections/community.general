...
def test_xenserver_guest_powerstate_set_power_state(mocker, fake_ansible_module, XenAPI, xenserver_guest_powerstate, power_state):
    ...
    mocker.patch('ansible_collections.community.general.plugins.modules.xenserver_guest_powerstate.get_object_ref', return_value=fake_xenapi_ref('VM'))
    mocker.patch('ansible_collections.community.general.plugins.modules.xenserver_guest_powerstate.gather_vm_params', return_value={"power_state": "Someoldstate"})
    mocked_set_vm_power_state = mocker.patch('ansible_collections.community.general.plugins.modules.xenserver_guest_powerstate.set_vm_power_state',
...
def test_xenserver_guest_powerstate_present(mocker, patch_ansible_module, capfd, XenAPI, xenserver_guest_powerstate):
    ...
    mocked_wait_for_vm_ip_address = mocker.patch('ansible_collections.community.general.plugins.modules.xenserver_guest_powerstate.wait_for_vm_ip_address',
                                                 return_value={})
