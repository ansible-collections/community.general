...
SCALEWAY_LOCATION = {
    'par1': {'name': 'Paris 1', 'country': 'FR', "api_endpoint": 'https://api.scaleway.com/instance/v1/zones/fr-par-1', "api_endpoint_vpc": 'https://api.scaleway.com/vpc/v1/zones/fr-par-1'},
    'EMEA-FR-PAR1': {'name': 'Paris 1', 'country': 'FR', "api_endpoint": 'https://api.scaleway.com/instance/v1/zones/fr-par-1', "api_endpoint_vpc": 'https://api.scaleway.com/vpc/v1/zones/fr-par-1'},

    'par2': {'name': 'Paris 2', 'country': 'FR', "api_endpoint": 'https://api.scaleway.com/instance/v1/zones/fr-par-2', "api_endpoint_vpc": 'https://api.scaleway.com/vpc/v1/zones/fr-par-2'},
    'EMEA-FR-PAR2': {'name': 'Paris 2', 'country': 'FR', "api_endpoint": 'https://api.scaleway.com/instance/v1/zones/fr-par-2', "api_endpoint_vpc": 'https://api.scaleway.com/vpc/v1/zones/fr-par-2'},

    'ams1': {'name': 'Amsterdam 1', 'country': 'NL', "api_endpoint": 'https://api.scaleway.com/instance/v1/zones/nl-ams-1', "api_endpoint_vpc": 'https://api.scaleway.com/vpc/v1/zones/nl-ams-1'},
    'EMEA-NL-EVS': {'name': 'Amsterdam 1', 'country': 'NL', "api_endpoint": 'https://api.scaleway.com/instance/v1/zones/nl-ams-1', "api_endpoint_vpc": 'https://api.scaleway.com/vpc/v1/zones/nl-ams-1'},

    'waw1': {'name': 'Warsaw 1', 'country': 'PL', "api_endpoint": 'https://api.scaleway.com/instance/v1/zones/pl-waw-1', "api_endpoint_vpc": 'https://api.scaleway.com/vpc/v1/zones/pl-waw-1'},
    'EMEA-PL-WAW1': {'name': 'Warsaw 1', 'country': 'PL', "api_endpoint": 'https://api.scaleway.com/instance/v1/zones/pl-waw-1', "api_endpoint_vpc": 'https://api.scaleway.com/vpc/v1/zones/pl-waw-1'},
}
