...
all_targets = ['BMC', 'BMCImage1', 'BMCImage2', 'BIOS', 'BIOS2', 'MainCPLD', 'MB_CPLD1', 'BPB_CPLD1', 'BPB_CPLD2', 'SCM_CPLD1', 'PDB', 'PDBPIC', 'HDDBPPIC', 'RT_NVME', 'RT_OTHER', 'RT_SA', 'UBM6']
                            ...
                            if target in reboot:
                                ...
                                for reb in what_reboots:
                                    if reb=="AC_PC_redfish":
                                        ...
                                        result = self.AC_PC_ipmi(IP, username, password, routing[model.upper()]) #based on the model end routing code changes 
                                        if not result:
                                            update_status="reboot_failed"
                                            break 
