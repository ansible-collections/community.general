...
class LookupModule(LookupBase):
    def run(self, terms, variables, _fetch_attachments=False, _file_download_path="", **kwargs):
        if not HAS_TSS_SDK:
        ...
        try:
            return [tss.get_secret(term, _fetch_attachments, _file_download_path) for term in terms]
