...
DOCUMENTATION = '''
    ...
    type: notification
    short_description: write execution time in log file
    description:
      - This callback will write execution time of playbook execution time and individual task time in log file
    requirements:
