...
- name: List all backup jobs
    ...
    api_host: "pve-main-btw-3.axt3.axt"
    api_user: "test@pve"
    api_token_id: "wn5XY34xUk23xr7qzaQpH2yh"
    api_token_secret: "083195a6-d87a-4cbe-94ea-99ea471db9c1"
...
proxmox_backup:
    ...
    contains:
      ...
      notes_template:
        ...
        type: str
      performance:
        description: Other performance-related settings. (Possible values [max-workers=<integer>] [,pbs-entries-max=<integer>])
        returned: on success
        type: str
      pigz:
      ...
      protected:
        ...
        type: bool
      prune_backups:
        description: Use these retention options instead of those from the storage configuration. (Format [keep-all=<1|0>] [,keep-daily=<N>] [,keep-hourly=<N>] [,keep-last=<N>] [,keep-monthly=<N>] [,keep-weekly=<N>] [,keep-yearly=<N>])
        returned: on success
        type: str
      quiet:
