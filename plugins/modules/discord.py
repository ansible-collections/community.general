...
- name: Send a message to the Discord channel with specific username and avatar
  community.general.discord:
    ...
    content: "This is a message from ansible"
    username: Ansible
    avatar_url: "https://docs.ansible.com/images/favicon/favicon-32x32.png"
    ...
    embeds:
      - title: "Embedded message"
        ...
        footer:
          text: "Author: Ansible"
        image:
          url: "https://docs.ansible.com/images/favicon/favicon-32x32.png"
  ...
  community.general.discord:
    ...
    embeds:
      ...
      - title: "Second message"
        ...
        footer:
          text: "Author: Ansible"
          icon_url: "https://docs.ansible.com/images/favicon/favicon-32x32.png"
        fields:
          - name: "Field 1"
