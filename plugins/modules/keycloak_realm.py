...
def main():
    ...
    meta_args = dict(
        ...
        web_authn_policy_acceptable_aaguids=dict(type='list', aliases=['webAuthnPolicyAcceptableAaguids']),
        ...
        web_authn_policy_passwordless_acceptable_aaguids=dict(type='list', aliases=['webAuthnPolicyPasswordlessAcceptableAaguids']),
        web_authn_policy_passwordless_attestation_conveyance_preference=dict(type='str', aliases=['webAuthnPolicyPasswordlessAttestationConveyancePreference']),
        web_authn_policy_passwordless_authenticator_attachment=dict(type='str', aliases=['webAuthnPolicyPasswordlessAuthenticatorAttachment']),
        ...
        web_authn_policy_passwordless_require_resident_key=dict(type='str', aliases=['webAuthnPolicyPasswordlessRequireResidentKey']),
        ...
        web_authn_policy_passwordless_signature_algorithms=dict(type='list', elements='str', aliases=['webAuthnPolicyPasswordlessSignatureAlgorithms']),
        web_authn_policy_passwordless_user_verification_requirement=dict(type='str', aliases=['webAuthnPolicyPasswordlessUserVerificationRequirement']),
        web_authn_policy_require_resident_key=dict(type='str', aliases=['webAuthnPolicyRequireResidentKey']),
