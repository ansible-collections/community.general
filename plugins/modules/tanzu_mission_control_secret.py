...
class TMCClusterGroupSecret(TMCSecret):
    ...
    def create(self, api_host, access_token, payload):
        ...
        new_payload = json.dumps(self._prepare_request(payload)).encode()
    ...
    def update(self, api_host, access_token, payload):
        ...
        new_payload = json.dumps(new_payload).encode()
...
def main():
    ...
    try:
        ...
        return module.fail_json(msg=e.read().decode())
    ...
    try:
        ...
        final_msg = (
            create_msg if export_msg == "" else create_msg + " and " + export_msg
        )
