...
class LXDContainerManagement(object):
    def __init__(self, module):
        ...
        self.key_file = self.module.params.get('client_key', '{0}/.config/lxc/client.key'.format(os.environ['HOME']))
        self.cert_file = self.module.params.get('client_cert', '{0}/.config/lxc/client.crt'.format(os.environ['HOME']))
