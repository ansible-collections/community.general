...
options:
    ...
    type:
        description:
            ...
            - Type V(ovs-bridge) is added in community.general 8.5.0.
            - Type V(ovs-interface) is added in community.general 8.5.0.
            - Type V(ovs-port) is added in community.general 8.5.0.
