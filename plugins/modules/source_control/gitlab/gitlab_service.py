...
# Copyright: (c) 2020, Raphaël Droz <raphael@droz.eu>
...
RAW_SERVICES_DEFINITIONS = {"asana": {"api_key": {"required": 1}, "restrict_to_branch": {}},
                            ...
                            "bugzilla": {"new_issue_url": {"required": 1}, "issues_url": {"required": 1}, "project_url": {"required": 1}, "description": {},
                                         "title": {}},
                            ...
                            "hangouts-chat": {"webhook": {"required": 1}, "push_events": {"type": "bool"}, "issues_events": {"type": "bool"},
                            ...
                            "redmine": {"new_issue_url": {"required": 1}, "project_url": {"required": 1}, "issues_url": {"required": 1},
                                        "description": {}},
                            "youtrack": {"project_url": {"required": 1}, "issues_url": {"required": 1}, "description": {}},
                            "slack": {"webhook": {"required": 1}, "username": {}, "channel": {}, "branches_to_be_notified": {},
                                      ...
                                      "confidential_issue_channel": {}, "merge_request_channel": {}, "note_channel": {}, "tag_push_channel": {},
                                      "pipeline_channel": {}, "wiki_page_channel": {}, "push_events": {"type": "bool"}, "issues_events": {"type": "bool"},
                                      "confidential_issues_events": {"type": "bool"}, "merge_requests_events": {"type": "bool"},
...
def main():
    ...
    ServicesHelper = GitLabServices(module, gitlab_instance, service)
    if state == 'absent':
